# -*- coding: utf-8 -*-
"""
Created on Sat Apr 17 14:03:37 2021
...
def generar_excel(predictions):
    ...
    df_y_test.to_excel('y_test_h1_rf.xlsx', index=False, header=True)
    
    df_predictions = pd.DataFrame(predictions)
    df_predictions.to_excel('predictions_h1_rf.xlsx', index=False, header=True)
