# -*- coding: utf-8 -*-
"""
Created on Sat Mar 13 16:32:36 2021

@author: alvar
"""

"""
Paso 1: Borramos registros de hotel 1
...
Paso 4: Borramos variables: babies, previous_bookings_not_canceled, company,
        days_in_waiting_list, is_repeated_guest (Poca V. Importance)
...
#borramos las filas donde hotel=1 (city hotel)
df.drop(df.index[0:39596], axis=0, inplace=True)
...
X_name.remove('hotel') #borramos hotel (siempre es 1)
...
df.to_csv("dataset_final_h1.csv", index=False)