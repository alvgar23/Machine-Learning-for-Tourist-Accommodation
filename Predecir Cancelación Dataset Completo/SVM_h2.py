# -*- coding: utf-8 -*-
"""
Created on Thu Apr 15 19:12:53 2021
...
#Leemos los datos (22)
df = pd.read_csv("dataset_final_h2.csv")
...
def sin_optimizar():
    ...
    # clf = svm.SVC(C=100, gamma=0.0001, class_weight='balanced')
...
def generar_excel(predictions):
    ...
    df_y_test.to_excel('y_test_h2_svm.xlsx', index=False, header=True)
    
    df_predictions = pd.DataFrame(predictions)
    df_predictions.to_excel('predictions_h2_svm.xlsx', index=False, header=True)
