...
"""
Paso 1: Borramos variable reservation_status
Paso 2: Borramos variables: babies, previous_bookings_not_canceled, company,
        days_in_waiting_list, is_repeated_guest, children, (Poca V. Importance)
Paso 3: Borramos arrival_date_month, arrival_date_year, 
        arrival_date_day_of_month (por correlación)
Paso 4: Chequeamos variable importance
Paso 5: Creamos dataset final
"""
...
X = df.drop('children',1, inplace=True)
...
df.to_csv("dataset_final_h2.csv", index=False)